...
Behavior* MowingBehavior::execute() {
  ...
  while (ros::ok() && !aborted) {
    if ((currentMowingPaths.empty() || currentMowingArea != currentMowingPathArea) &&
        !create_mowing_plan(currentMowingArea)) {
...
bool MowingBehavior::execute_mowing_plan() {
  ...
  while (currentMowingPath < currentMowingPaths.size() && ros::ok() && !aborted) {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    {
      ...
      if (path.is_outline && getConfig().add_fake_obstacle && first_point_trim_counter == 0) {
      ...
      mbfClient->sendGoal(moveBaseGoal, NULL, [&]() { mbfActive = true; });
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////
    {
      ...
      std::atomic<bool> mbfActive{false};
      mbfClientExePath->sendGoal(exePathGoal, NULL, [&]() { mbfActive = true; });
      actionlib::SimpleClientGoalState current_status(actionlib::SimpleClientGoalState::PENDING);
      ros::Rate r(10);
