...
Behavior* UndockingBehavior::execute() {
  ...
  double undock_distance = config.undock_distance + 2 * config.undock_distance_variance * rand() / RAND_MAX -
                           config.undock_distance_variance;
  double incremental_distance = undock_distance / straight_undock_point_count;
